...
//  WandApp
//
//  Created by Guruprasad on 27/11/17.
    ...
    fileprivate func executeDataRequest() -> DataRequestID? {
        ...
        let fetchCompletion = {(result: (DataResult<D>)) -> Void in
            ...
            case .failure(let error):
                ...
                ///so .needRetry is not returned for invalid accesstoken. But this code is kept for any future requirement of API retry functionality
